...
## Structure : nettoyage des données divers documents (KP, Kiruna, SolarWinds)

import pandas as pd
from pathlib import Path

INPUT_FILE  = Path(r"c:\Users\flore\Desktop\IA_avancée\kp-compiled\kp.csv")
OUTPUT_FILE = Path(r"c:\Users\flore\Desktop\IA_avancée\testVsCODE\kp_filtered.csv")
